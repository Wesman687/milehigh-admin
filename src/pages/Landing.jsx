...
function Landing() {
  ...
  const { fetchFlower, fetchOrders, flowers, orders, loading, orderProductTotals, getTotals, topId, topTotal, top, topIdOption, topSize, topSizeAmount } = useContext(AdminContext)
  useEffect(() => {
    getTotals()
  }, [])
  return (
